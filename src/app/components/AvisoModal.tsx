...
function AvisoModal({produto}:{produto:string}) {
  ...
  return (
    <div className={`${aviso?"translate-y-0":"translate-y-[200px]"} absolute bottom-20   md:bottom-5 right-5 transition-all duration-300 ease-in-out  font-poppins  rounded-lg globalShadow  border-[2px] border-mainStroke`}>
