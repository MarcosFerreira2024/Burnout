...
function NavBarMobile() {
  return (
    <>
        <aside className='items-center globalShadow fixed gap-2 h-[60px] top-0 w-[100%] bg-mainBg    flex  justify-between p-2  '>
        ...
        <main className='px-5 globalShadow h-[60px] py-5 fixed bottom-0 w-[100%] bg-mainBg     '>
